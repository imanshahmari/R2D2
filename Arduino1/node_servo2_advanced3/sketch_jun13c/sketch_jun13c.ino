...
void loop()
{ 
  distanceReading_front_output.data = distanceRead(TRIGGER_PIN_front,ECHO_PIN_front);
  distanceReading_back_output.data = distanceRead(TRIGGER_PIN_back,ECHO_PIN_back);
