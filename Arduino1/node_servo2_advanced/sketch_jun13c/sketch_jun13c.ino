...
{ 
  ...
  distanceReading_front_output.data = (duration_front / 2.0) / 29.0;


  digitalWrite(TRIGGER_PIN_back, HIGH);
  digitalWrite(TRIGGER_PIN_back, LOW);
  duration_back = pulseIn (ECHO_PIN_back, HIGH);
  distanceReading_back_output.data = (duration_back / 2.0) / 29.0;
