...
void DoNothing(serial::Serial& my_serial, int degree){
...
void GoForward(serial::Serial& my_serial, int degree){
    my_serial.flushOutput();
...
void ActuateWithDirection(serial::Serial& my_serial, int degree ){
